    ...
    <div className="min-h-screen flex items-center justify-center bg-[rgb(var(--bg))] px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-[rgb(var(--surface))] rounded-2xl shadow-sm border border-[rgb(var(--border))] p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-12 bg-[rgb(var(--primary))] text-white rounded-md text-sm font-medium hover:bg-[rgb(var(--primary-hover))] transition-colors"
        ...
        <p className="text-center text-sm text-[rgb(var(--muted))] mt-6">
          ...
          <a href="#" className="text-[rgb(var(--primary))] font-medium hover:underline">Create one</a>
        </p>
